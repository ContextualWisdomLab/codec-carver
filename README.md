...
[`docs/architecture/segmentation-reconciliation.md`](https://github.com/ContextualWisdomLab/codec-carver/blob/main/docs/architecture/segmentation-reconciliation.md).
...
[`docs/architecture/gpu-transcription-rust-backend.md`](https://github.com/ContextualWisdomLab/codec-carver/blob/main/docs/architecture/gpu-transcription-rust-backend.md).
