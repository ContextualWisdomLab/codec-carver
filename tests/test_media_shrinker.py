...
class FastPathTests(unittest.TestCase):
    ...
    def test_ffprobe_timeout(self, mock_run: MagicMock) -> None:
        ...
        from media_shrinker import MediaShrinkerError, probe_media
        import subprocess
    ...
    def test_silencedetect_timeout(self, mock_run: MagicMock) -> None:
        ...
        from media_shrinker import MediaShrinkerError, detect_silence_intervals
        import subprocess
    ...
    def test_brctl_timeout(self, mock_run: MagicMock, mock_which: MagicMock) -> None:
        ...
        from media_shrinker import MediaShrinkerError, download_from_icloud
        import subprocess
    ...
    def test_convert_timeout(
        ...
        from media_shrinker import ConversionPlan, MediaShrinkerError, _execute_plan
        import subprocess
