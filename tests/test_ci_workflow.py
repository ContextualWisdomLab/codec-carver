...
class CiWorkflowTests(unittest.TestCase):
    ...
    def test_rust_job_installs_and_uses_rust_1_85_with_rustfmt(self) -> None:
        ...
        formatting = "rustup run 1.85.0 cargo fmt --manifest-path rust-core/Cargo.toml -- --check"
        tests = (
            "rustup run 1.85.0 cargo test --locked --all-targets "
