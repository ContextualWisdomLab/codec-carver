"""Security-focused tests for Media Shrinker."""
import unittest
...
class SecurityTests(unittest.TestCase):
    """Test cases specifically checking for security vulnerabilities."""
    def test_silence_noise_validation(self):
        """Test that silence_noise input is validated strictly."""
    ...
    def test_probe_media_uses_explicit_input_flag_for_dash_prefixed_path(
        ...
        """Test that probing uses explicit -i flag, preventing argument injection."""
