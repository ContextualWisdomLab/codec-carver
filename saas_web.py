...
<body>
    <div class="box" id="drop-zone">
        ...
        <script>
            ...
            const presetButtonsContainer = document.getElementById('preset_buttons_container');
            const presetButtons = presetButtonsContainer ? presetButtonsContainer.querySelectorAll('.preset-btn') : [];
