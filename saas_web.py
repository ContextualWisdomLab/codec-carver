...
<head>
    ...
    <style>
        ...
        .preset-btn[aria-pressed="true"] { background-color: #004085; color: white; border-color: #004085; }
    </style>
</head>
<body>
