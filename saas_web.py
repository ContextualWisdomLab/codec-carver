...
<head>
    ...
    <style>
        ...
        .preset-btn.active { background-color: #0056b3; color: white; border-color: #004085; }
    </style>
</head>
<body>
        ...
        <script>
            ...
            document.getElementById('target_bytes').addEventListener('input', function() {
                ...
                document.querySelectorAll('.preset-btn').forEach(btn => {
                    const isActive = parseInt(btn.getAttribute('data-bytes'), 10) === val;
                    if (isActive) {
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                if (targetBytesInput) {
                    targetBytesInput.dispatchEvent(new Event('input'));
                }
            });
