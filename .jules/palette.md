...
## 2026-09-15 - [Client-side File Validation UX]
**Learning:** [When validating file.type for uploads, HTML accept is easily bypassed. Browsers may also omit MIME types. A 3-state UX is needed: accept valid, block invalid (with aria-invalid), and warn on unknown without blocking.]
**Action:** [Implement 3-state validation for all file uploads moving forward.]
