...
## 2024-06-25 - Visual Feedback for aria-invalid
...
**Action:** When dynamically toggling `aria-invalid="true"`, always ensure there is a corresponding CSS rule (e.g., `input[aria-invalid="true"] { outline: 2px solid #dc3545; border-color: #dc3545; }`) to provide immediate, distinct visual feedback to sighted users.
