...
## 2024-09-08 - Client-side File Type Validation
**Learning:** When implementing file inputs or drop zones in web UIs, remember that the HTML accept attribute does not reliably prevent invalid files from being dropped.
**Action:** Always add explicit client-side JavaScript validation against file.type and provide inline accessibility feedback using setCustomValidity and aria-invalid to ensure a smooth, accessible user experience.
