...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--size-limit-bytes", type=int, default=DEFAULT_SIZE_LIMIT_BYTES, help="Only convert files larger than this size")
    parser.add_argument("--target-bytes", type=int, default=DEFAULT_TARGET_BYTES, help="Target output file size")
    parser.add_argument("--max-duration-seconds", type=float, default=DEFAULT_MAX_SEGMENT_DURATION_SECONDS, help="Maximum duration for generated segments")
    parser.add_argument("--output-dir", type=Path, default=Path("under_2gb"), help="Directory to save converted files")
    parser.add_argument("--report", type=Path, default=Path("under_2gb/conversion_report.json"), help="Path to write the conversion report JSON")
